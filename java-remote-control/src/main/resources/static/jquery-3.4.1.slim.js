    ...
    function(e, t) {
        ...
        var h = function(n) {
            ...
            for (e in p = se.support = {}, i = se.isXML = function(e) {
                ...
                }), v = v.length && new RegExp(v.join("|")), s = s.length && new RegExp(s.join("|")), t = J.test(a.compareDocumentPosition), y = t || J.test(a.contains) ?
                    function(e, t) {
            ...
            function xe(s, e, t) {
                ...
                return e.first ?
                    function(e, t, n) {
                        ...
                        } else while (e = e[u]) if (1 === e.nodeType || f) if (i = (o = e[N] || (e[N] = {}))[e.uniqueID] || (o[e.uniqueID] = {}), l && l === e.nodeName.toLowerCase()) e = e[u] || e;
                        else {
            ...
            function Ee(e) {
                for (var i, t, n, r = e.length, o = x.relative[e[0].type], a = o || x.relative[" "], s = o ? 1 : 0, u = xe(function(e) {
                    ...
                    return i = null, r
                }]; s < r; s++) if (t = x.relative[e[s].type]) c = [xe(we(c), t)];
                else {
        ...
        function xe(e, t, n, r, i) {
            for (var o, a, s, u, l, c, f = t.createDocumentFragment(), d = [], p = 0, h = e.length; p < h; p++) if ((o = e[p]) || 0 === o) if ("object" === T(o)) E.merge(d, o.nodeType ? [o] : o);
            else if (be.test(o)) {
